...
function updateParallax() {
    ...
    // scroll começa quando o spacer entra na viewport (descontando header)
    const start = spacerTop - headerH;
    // scroll termina quando o fim do spacer sai da viewport
    const end   = spacerTop + spacerH - viewportH;
